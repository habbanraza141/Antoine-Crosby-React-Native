...
const ContactInformation = () => {
    return (
        <View style={styles.container}>
            ...
            <View>
                <Text style={{marginTop: 25, fontStyle: 'italic', fontWeight: '500', fontSize: 20}} >Contact Information</Text>
            ...
            <View style={{height: 159, width: '100%', backgroundColor: '#EFEEEC', marginVertical: 20}}>
            ...
            <View style={{height: 159, width: '100%', backgroundColor: '#EFEEEC'}}>
