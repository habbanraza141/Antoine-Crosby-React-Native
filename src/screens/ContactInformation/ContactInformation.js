        ...
        <View style={styles.container}>
            <SafeAreaView>
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <View>
                        <Text style={{ fontStyle: 'italic', fontWeight: '500', fontSize: textScale(20) }} >Contact Information</Text>
                    ...
                    <View style={{ height: 159, width: '100%', backgroundColor: '#14252A' }}>
                        <Text style={{ color: '#fff', fontSize: textScale(18), marginVertical: 15, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600' }} >Store Info</Text>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingLeft: 20, paddingVertical: 20 }} >
                            ...
                            <Text style={{ color: '#fff', fontSize: textScale(16), fontWeight: '600', fontStyle: 'italic' }} >Antoine Crosby</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center', paddingLeft: 20, }} >
                            ...
                            <Text style={{ color: '#fff', fontSize: textScale(16), fontWeight: '600', fontStyle: 'italic' }} >contactus@antoinecrosby.com</Text>
                        </View>
                    </View>
                    <View style={{ height: 159, width: '100%', backgroundColor: '#dcdcdc', marginVertical: 20 }}>
                        <Text style={{ fontSize: textScale(18), marginVertical: 15, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600' }} >Outlet 1</Text>
                    ...
                    <View style={{ height: 159, width: '100%', backgroundColor: '#dcdcdc' , marginBottom: 20}}>
                        <Text style={{ fontSize: textScale(18), marginVertical: 15, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600' }} >Outlet 2</Text>
                        <Text style={{ marginVertical: 5, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600', color: '#70695e' }} >jvbdf fdbcjdh djsbf sdbfd hre jasbd bd</Text>
                        <Text style={{ marginVertical: 5, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600', color: '#70695e' }} >cnjsnc@bfdjbd.com</Text>
                        <Text style={{ marginVertical: 5, fontStyle: 'italic', paddingLeft: 15, fontWeight: '600', color: '#70695e' }} >+934 7834 3746</Text>
                    </View>
