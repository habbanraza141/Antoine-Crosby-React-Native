            ...
            <SafeAreaView>
                <ScrollView showsVerticalScrollIndicator={false} >
                    <HeaderComponent
                        ...
                        hdrText={'Cart'} />
                    <View style={{ height: 121, backgroundColor: '#F4F5F7', width: '100%', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 6 , justifyContent: 'space-between'}}>
                        ...
                        <TouchableOpacity style={{ height: 23, width: 24, borderRadius: 12, backgroundColor: '#DFDFDF', alignItems: 'center', justifyContent: 'center',position: 'absolute', right: 15, bottom: 15 }}>
                            <Image
